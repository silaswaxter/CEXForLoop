...
//        limits
#ifndef IMPL_CEX_FOR_LOOP_FUNCTIONAL_H
#define IMPL_CEX_FOR_LOOP_FUNCTIONAL_H
...
struct LinearCEXForFunctor {
  ...
  template <IType StartLocal = Start, IType EndLocal = End,
            IType IncLocal = Inc>
  static constexpr auto func(const FunctorData& initial_data) ->
...
struct ExponentialCEXForFunctor {
  ...
  template <IType StartLocal = Start, IType EndLocal = End,
            IType IncLocal = Inc>
  static constexpr auto func(const FunctorData& input_data) ->
    ...
    auto output_data =
        LinearCEXForFunctor<IType, StartLocal, EndLocal, IncLocal,
                            ...
                            BodyFunctor>::template func(input_data);
    return output_data;
  }
  ...
  static constexpr auto func(const FunctorData& input_data) ->
    ...
    constexpr auto kParentOutputData =
        LinearCEXForFunctor<IType, StartLocal, kParentEnd, IncLocal,
                            BoolExpressionFunctor,
                            BodyFunctor>::func(input_data);
    ...
    return LinearCEXForFunctor<IType, 0, kNChildren, 1,
                               ...
                               ChildExpMetaFunctor>::func(kParentOutputData);
  }
};
...
#endif  // IMPL_CEX_FOR_LOOP_FUNCTIONAL_H
